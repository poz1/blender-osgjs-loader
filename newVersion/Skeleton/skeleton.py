...
class Skeleton:
    ...
    def draw(self):
        ...
        if not self.name:
            self.name = 'szkielet-'+str(objectID)
        ...
        if self.parentTestFlag == False and self.nameTestFlag == False:
            ...
            if self.IK == True:
                ...
                for key in list(self.armature.bones.keys()):
    ...
    def create_bones(self):
        self.armature.makeEditable()
        boneList = []
        for bone in list(self.armature.bones.values()):
